  ...
  return (
    ...
    >
      <div className="space-y-8">
        {/* Header Premium com Gradiente Médico Brasileiro - Azul e Verde */}
        <div className="bg-gradient-to-r from-blue-500 via-cyan-500 to-emerald-500 rounded-2xl p-8 text-white relative overflow-hidden shadow-xl">
          <div className="absolute inset-0 bg-white/5 backdrop-blur-sm"></div>
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-4">
              <div className="h-16 w-16 bg-white/15 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/20">
                <Brain className="h-8 w-8 text-white" />
              </div>
              <div>
                <h1 className="text-3xl font-bold mb-2">
                  Central de Inteligência CBHPM
                </h1>
                <p className="text-white/90 text-lg">
                  Análise avançada com IA para maximizar receita e reduzir glosas
                </p>
              </div>
              <div className="ml-auto">
                <Badge className="bg-white/15 text-white border-white/20 px-4 py-2 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20">
                  <div className="flex items-center gap-3">
                    <div className="h-12 w-12 bg-emerald-400/20 rounded-lg flex items-center justify-center">
                      <DollarSign className="h-6 w-6 text-emerald-200" />
                    </div>
                    <div>
                      <p className="text-white/80 text-sm font-medium">Receita Total</p>
                      <p className="text-2xl font-bold">
                        {formatCurrency(analyticsData.summary.total_recebido_historico)}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {formatPercentage(analyticsData.summary.taxa_recuperacao_media)}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20">
                  <div className="flex items-center gap-3">
                    <div className="h-12 w-12 bg-cyan-400/20 rounded-lg flex items-center justify-center">
                ...
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20">
                  <div className="flex items-center gap-3">
                    <div className="h-12 w-12 bg-teal-400/20 rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {formatCurrency(analyticsData.summary.valor_medio_procedimento)}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          <p className="text-gray-600 font-medium">Demonstrativos</p>
                          <p className="text-lg font-bold text-blue-700">
              ...
              <Card className="bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-900/20 dark:to-emerald-900/20 border-teal-200 shadow-sm">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <p className="font-semibold text-teal-700">Sistema Operacional</p>
                    <p className="text-gray-600 text-sm">Análise em tempo real ativa</p>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                            ...
                            <div className="bg-red-50 rounded-lg p-3">
                              <p className="text-sm text-red-600 font-medium">Glosas</p>
            ...
            <Card className="bg-white border-gray-200 shadow-sm">
              ...
              <CardContent>
                ...
                analyticsData.temporal_analytics.monthly_performance.length > 0 ? (
                  <div className="space-y-4">
                    <h3 className="font-semibold text-gray-800">Performance Mensal</h3>
                    <div className="grid gap-4">
