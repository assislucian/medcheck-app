...
const variantStyles = {
  ...
  neutral:
    'bg-muted/60 text-muted-foreground dark:bg-muted-800/40 dark:text-muted-foreground',
} as const;
...
const InfoCard = ({
  ...
  return (
    <div
      className={cn(
        'w-full rounded-xl border p-3 sm:p-4 shadow-sm transition-all hover:shadow-md',
    ...
    >
      <div className="flex items-center justify-between">
        ...
        {badge && (
          <span
            className={cn(
              'inline-flex items-center rounded-full px-1.5 sm:px-2 py-0.5 sm:py-1 text-xs font-medium',
