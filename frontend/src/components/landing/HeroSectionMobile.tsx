        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center space-x-2">
            <Button
              ...
              variant="ghost"
              size="sm"
              className="text-blue-600 font-semibold px-3 py-2 h-auto"
            >
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-sm mx-auto text-center">
            ...
            <div className="space-y-3 mb-10">
              ...
              <Button
                ...
                variant="outline"
                className="w-full py-4 border-gray-300 text-gray-700 text-lg font-semibold rounded-xl hover:bg-gray-50 active:scale-95 transition-all duration-200"
                style={{ minHeight: '44px' }}
              >
        ...
        <section id="precos" className="px-4 mb-12">
          <div className="text-center p-8 rounded-xl bg-gradient-to-r from-blue-600 to-emerald-600 text-white shadow-lg">
            ...
            <Button
              onClick={handleStartTrial}
              className="w-full py-4 bg-white text-blue-600 hover:bg-gray-100 text-lg font-bold rounded-xl transition-all duration-300 active:scale-95 shadow-lg"
              style={{ minHeight: '44px' }}
            >
