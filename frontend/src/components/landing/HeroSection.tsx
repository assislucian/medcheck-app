        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Auditoria médica
              <span className="block mt-2 text-primary">simplificada</span>
            </h1>
            ...
            <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-300 leading-relaxed mt-6 max-w-lg">
              ...
              já ajudou mais de 10.000 médicos brasileiros.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-6">
              <Button
                ...
                size="lg"
                variant="default"
                className="rounded-md text-lg px-8 h-12 transition-all duration-300 hover:translate-y-[-2px] shadow-lg shadow-primary-500/20"
              >
